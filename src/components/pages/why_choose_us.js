      ...
      <div className="choose-us">
        ...
        <div className="reasons">
          ...
          <div className="reason">
            ...
            <p>
              Instructors and learners can hold live meetings using our
              resources for teachers and students interractions and to aid
              learning.Learners can choose to take self paced learning or
          ...
          <div className="reason">
            ...
            <h3>Skill Market</h3>
            <p>
              After training we provide learners with job recommendations that
              are relevant to their skills. Learners can choose to be
              freelancers too.
            </p>
          </div>
          <div className="reason">
            ...
            <h3>Linguistic</h3>
            <p>
              LearnROOM promotes African instructors and Language.There should
              be no barrier in speaking any language you aspire to speak.
            </p>
          </div>
          <div className="reason">
            <FaFileDownload />
