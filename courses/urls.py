...
router.register('courses', CourseListAPIView, basename='courselist')
...
urlpatterns = [
	path('courses/<int:pk>/rating/<int:rating>/', CourseListAPIView.as_view({"get": "rating"})),
	path('courses/<int:pk>/enroll/', CourseListAPIView.as_view({"get": "enroll"}))
		] + router.urls
